...
public class LoginSteps extends CommonMethods {
    ...
    // public WebDriver driver;   -> create the driver instance
    ...
    public void user_is_navigated_to_hrms_application() throws InterruptedException {
        ...
        openBrowserAndLaunchApplication(); // it is from common methods , open browser and launch
    }
    ...
    public void user_enters_admin_username_and_password() throws InterruptedException {
        ...
        // WebElement usernameTextField = driver.findElement(By.xpath("//*[@id='txtUsername']")); //-> * is all tag
    ...
    public void user_is_successfully_logged_in() {
        ...
        // assertions to check if hte element exist
        //
        // assert true, it is a boolean condition we write to
